...
Поля:
- name: марка и модель авто (например "BMW X5", "MINI COOPER COUNTRYMAN"). Если не упомянуто — "—"
{PLATE_PROMPT}
...
- condition: состояние. Если чистая — "чистая". Если есть повреждения — перечисли. Если не упомянуто — "—"
...
{{"name": "BMW X5", "plate": "56무2942", "price": "43400000", "keys": "2", "condition": "чистая", "kesanso": "100%", "medobi": "440000", "malso": "сразу", "city": "Чонджу"}}"""
